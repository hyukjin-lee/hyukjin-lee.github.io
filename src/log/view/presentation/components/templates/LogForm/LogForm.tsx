...
import {LogContent} from "../../organisms";
...
interface Props {
  isUpdating?: boolean;
  initialValues?: LogDetailResponse;
  onSubmit(request: LogRequestDto): Promise<void>;
}

const LogForm = ({ isUpdating, initialValues, onSubmit }: Props) => {
  const theme = useTheme();
  const styles = useMemo(() => styleObjects(theme), [theme]);

  return <Formik<LogRequestDto>
    enableReinitialize
    initialValues={{
